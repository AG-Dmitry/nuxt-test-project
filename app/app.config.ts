  ...
  ui: {
      ...
      compoundVariants: [
        {
          ...
          variant: 'solid',
          class:
            'text-inverted bg-primary hover:bg-primary/75 active:bg-primary/75 disabled:bg-neutral-500 aria-disabled:bg-neutral-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary',
        }, // replace disabled:___-neutral-500 with a proper palette color
        {
          color: 'primary',
          variant: 'outline',
          class:
            'ring ring-inset ring-primary/50 text-primary hover:bg-primary/10 active:bg-primary/10 disabled:ring-neutral-500 aria-disabled:ring-neutral-500 disabled:text-neutral-500 aria-disabled:text-neutral-500 disabled:bg-transparent aria-disabled:bg-transparent dark:disabled:bg-transparent dark:aria-disabled:bg-transparent focus:outline-none focus-visible:ring-2 focus-visible:ring-primary',
        }, // replace disabled:___-neutral-500 with a proper palette color
        {
          color: 'primary',
          variant: 'soft',
    ...
    error: {
      slots: {
        ...
        statusCode: 'text-base font-bold text-primary sm:text-6xl',
        statusMessage:
          'mt-6 text-4xl sm:text-3xl text-highlighted text-balance',
